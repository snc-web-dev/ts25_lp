...
!function (a, b, c) {
  ...
  function i(a, b, c) {
    var d,
      ...
      j = "function" == typeof b,
      k = !0 === c;
    for (e = a && a.length, c = k ? null : c; e > i; i++) f = a[i], d = j ? !b.call(c, f, i, a) : b ? _typeof(f) !== b : !f, d === k && (g[h++] = f);
    return g;
  }
  function j(a, c) {
    if (null == a || null == c) return a;
    if ("object" == _typeof(c) && b(c.length)) _.apply(a, i(c, "undefined", !0));else for (var d in c) cb.call(c, d) && void 0 !== c[d] && (a[d] = c[d]);
    return a;
  }
  function k(a, c, d) {
    return null == a ? a : ("object" == _typeof(a) && !a.nodeType && b(a.length) ? g(a, c, d) : c.call(d || a, a), a);
  }
  function l(a) {
  ...
  function K(a) {
    return k(a, function (a) {
      if ("object" != _typeof(a)) throw new TypeError("@create");
      var b,
        c = ub(O).configure(a),
        d = c.verge,
        e = c.breakpoints,
  ...
  return O = function () {
    ...
    return {
      ...
      decideValue: function decideValue() {
      ...
      prepareData: function prepareData(b) {
    ...
    deviceMin: function deviceMin() {
      return mb;
    },
    deviceMax: function deviceMax() {
      return lb;
    },
    noConflict: L,
    create: K,
