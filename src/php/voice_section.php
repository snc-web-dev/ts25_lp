...
<section class="voice" id="voice">
    <div class="inner fade">
        <div><img src="img/con05_logo.webp" alt="七夕スカイランタン祭り2025" class="con05logo">
        ...
        <ul class="voiceList">
            <?php foreach ($voices as $index => $voice): ?>
                <li data-voice-index="<?php echo $index; ?>">
                    <dl>
                        <dt><?php echo htmlspecialchars($voice['name'], ENT_QUOTES, 'UTF-8'); ?>さん<span>(<?php echo htmlspecialchars($voice['gender'], ENT_QUOTES, 'UTF-8'); ?>/<?php echo htmlspecialchars($voice['age'], ENT_QUOTES, 'UTF-8'); ?>)</span></dt>
                        <dd>
